...
/*
 ----------------------------------------------------------------
 -   正式环境为@"beta."、公司内部测试为@"alpha."、dev上测试为@""      -
 ----------------------------------------------------------------
 */
...
#define ConfigBaseDomain @"http://101.200.204.65"  // 基础域：http://107room.com，线上测试域：http://101.200.204.65，测试域：http://192.168.199.200:8081
